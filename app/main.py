...
async def lifespan(app: FastAPI):
    ...
    logger.info("IDNA Didi v10.5.5 ready")
    yield
...
@app.get("/healthz")
async def health():
    return {"status": "ok", "version": "10.5.5"}
...
async def health_detail():
    ...
    try:
        ...
        db.close()
    return {"status": "ok", "version": "10.5.5", "questions": q_count, "levels": levels}
