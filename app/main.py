...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # v10.6.3: Fix test student name (was "Priya" which conflicts with anti-Priya rule)
    ...
    logger.info("IDNA Didi v10.6.6 ready")
    yield
...
@app.get("/healthz")
async def health():
    return {"status": "ok", "version": "10.6.6"}
...
async def health_detail():
    ...
    try:
        ...
        db.close()
    return {"status": "ok", "version": "10.6.6", "questions": q_count, "levels": levels}
