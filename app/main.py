...
async def lifespan(app: FastAPI):
    ...
    logger.info("IDNA Didi v10.6.9 ready")
    yield
...
@app.get("/healthz")
async def health():
    return {"status": "ok", "version": "10.6.9"}
...
async def health_detail():
    ...
    try:
        ...
        db.close()
    return {"status": "ok", "version": "10.6.9", "questions": q_count, "levels": levels}
