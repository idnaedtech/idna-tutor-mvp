...
from . import tutoring_pb2 as tutoring__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in tutoring_pb2_grpc.py depends on'
...
def add_TutoringServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'idna.v1.TutoringService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('idna.v1.TutoringService', rpc_method_handlers)
